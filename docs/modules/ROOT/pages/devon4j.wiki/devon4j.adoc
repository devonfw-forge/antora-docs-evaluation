...
With devon4j we support both link:spring[spring] and link:quarkus[quarkus] as major frameworks.
...
Only the sections link:spring[spring] and link:quarkus[quarkus] contain documentation that is specific to the respective approach.

If you're trying to decide which of the two frameworks to use, have a look at link:decision-between-Spring-and-Quarkus[this guide].
...
include::guide-migration-spring-quarkus.adoc[leveloffset=+2]

include::Spring-native-vs-Quarkus.adoc[leveloffset=+2]
