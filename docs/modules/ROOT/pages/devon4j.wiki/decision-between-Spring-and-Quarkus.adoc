...
For more information about Quarkus and its support for devonfw please refer to the link:quarkus[Quarkus introduction guide].
...
We also provide a link:quarkus/getting-started-for-spring-developers[guide for Spring developers] who want to adopt or try Quarkus for their (next) projects as it really has some gamechanging advantages over Spring.
