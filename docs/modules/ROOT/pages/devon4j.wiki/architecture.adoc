...
* link:guide-domain-layer[domain layer] for the data access, especially persistence (in the link:guide-structure-classic[classic project structure] this layer is named link:guide-dataaccess-layer[data-access layer]).
...
|link:guide-domain-layer[persistence]|OR-mapper|http://www.oracle.com/technetwork/java/javaee/tech/persistence-jsp-140049.html[JPA] | http://hibernate.org/orm/[hibernate]
...
|link:guide-service-layer[service]|link:guide-soap[SOAP services]|https://jcp.org/en/jsr/detail?id=224[JAX-WS]|http://cxf.apache.org/[CXF]
|link:guide-service-layer[service]|link:guide-rest[REST services]|https://jax-rs-spec.java.net/[JAX-RS]| http://cxf.apache.org/[CXF]
